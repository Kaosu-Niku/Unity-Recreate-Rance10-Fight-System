...
這是一個 Unity 專案，專案內容在於還原 Rance 10 這款遊戲的戰鬥系統<br>
但我並沒有將圖片、音訊...等等的美術素材提交上此倉庫，避免可能會有侵權問題<br>
該倉庫主要目的用於做為個人的作品集以做相關學術用途<br>
重點在於遊戲系統的程式架構方面設計，而非美術呈現<br>
...
UI相關的交互都使用event事件通知觸發的方式觸發，同樣也是避免緊耦合，達成邏輯和畫面的乾淨分割<br>
亦會注重封裝性，只公開get屬性，不隨意公開set屬性，會封裝function供外部調用來set屬性<br>
有實作存檔功能，存檔的檔案格式使用主流的JSON格式<br>
